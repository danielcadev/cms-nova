...
export default function SignUp() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 relative">
      ...
      <div className="absolute top-20 left-20 w-64 h-64 bg-gradient-to-br from-green-500/8 to-transparent rounded-full blur-3xl animate-pulse opacity-60" />
      <div className="absolute bottom-20 right-20 w-80 h-80 bg-gradient-to-tl from-blue-500/6 to-transparent rounded-full blur-3xl animate-pulse opacity-40" style={{ animationDelay: '2s' }} />
